      ...
      {trendingItems.map((item) => (
        ...
        >
          ...
          <div className='relative z-10 p-6 flex flex-col h-full justify-end'>
            <h1 className='text-xl font-bold text-white mb-2 drop-shadow'>{item.item_name}</h1>
            <h2 className='text-orange-300 font-bold text-lg mb-4 drop-shadow'>₹{item.item_price}</h2>
            <div className='flex flex-row gap-3'>
              ...
              <button className="bg-orange-500 hover:bg-green-200 text-white px-4 py-2 rounded-lg font-semibold shadow transition w-fit focus:outline-none focus:ring-2 focus:ring-orange-600">
                Add to cart
              </button>
            </div>
          </div>
